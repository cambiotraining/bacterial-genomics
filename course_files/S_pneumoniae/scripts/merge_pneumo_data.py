...
def parser_args(args=None):
    """ 
    Function for input arguments for merge_pneumo_data.py
    """
    Description = 'Merge Pathogenwatch output and sample_info.csv to create a summary table'
    Epilog = """Example usage: python merge_pneumo_data.py """
    ...
    parser.add_argument("-o", "--output_file", type=str, default="pneumo_metadata.tsv", help="Merged Pneumo summary file (default: 'pneumo_metadata.tsv').")
...
def main(args=None):
    ...
    ## Remove _T1 from sample_ids to match tip labels
    final_merged_df['sample'] = final_merged_df['sample'].str.replace('_T1','')
